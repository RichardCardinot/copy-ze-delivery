...
import { Container, Logo, Titulo, SubTitulo, InputEmail, ContainerCheckBox, Email, TextoBotao, Botao, Linha, ContainerLinha, TextoRedes, Icone, ContSemCadastro } from './styles';
    ...
    return (
        <Container>
            ...
            <Botao style={{backgroundColor: '#3b5998', flexDirection: 'row'}}>
                ...
                <TextoRedes style={{color: '#FFFFFF'}}>CONTINUAR COM FACEBOOK</TextoRedes>
            </Botao>

            <Botao style={{marginTop: 0, backgroundColor: '#454443', flexDirection: 'row'}}>
                <Icone source={logoAplle} />
                <TextoRedes>CONTINUAR COM A APPLE</TextoRedes>
            </Botao>

            <ContSemCadastro    
                onPress={screenSemCadastro}> 
